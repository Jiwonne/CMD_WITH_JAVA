/**
 * Assignment title: Bonus Assignment - CLI Utility Development Task1
...
public class UtilityCLI {
	...
	static final String GET_MY_LOCAL_WIFI_IP_AND_MAC = "2";		// variable 2
	/*
	...
	public static void main(String[] args) {
		...
		System.out.println("21F CST 8109 Section 10 Bonus Activity CLI Utility Development for Prof. Risvan Coskun");
		System.out.println("<Jiwon Hwang> <040991933> <Computer Programming> <Algonquin College>");
	...
	private static void menu() {
		...
		System.out.println("***********************************************************");
		System.out.println("L or l: " + LIST_OF_COMMANDS);
		System.out.println("E or e: " + EXIT);
		System.out.println("***********************************************************");
		runProgram();
	}
